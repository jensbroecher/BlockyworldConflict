...
func _ready() -> void:
	defs = {
		Kind.SOLDIER_SQUAD: {
			...
			"blurb": "Cheap infantry. Can seize buildings.",
		},
		Kind.JEEP: {
			"name": "Jeep",
			"short": "Jeep",
			...
			"blurb": "Fast scout. Light gun, thin armor.",
		},
		Kind.IFV: {
			"name": "IFV",
			"short": "IFV",
			...
			"blurb": "Infantry fighting vehicle. All-rounder.",
		},
		Kind.TANK: {
			"name": "Tank",
			"short": "Tank",
			...
			"blurb": "Heavy armor. Punches through rock walls.",
		},
		Kind.ARTILLERY: {
			"name": "Artillery",
			"short": "Arty",
			...
			"blurb": "Long-range howitzer. Minimum range.",
		},
		Kind.MLRS: {
			"name": "MLRS",
			"short": "MLRS",
			...
			"splash": 7.0,
			"wall_damage": 22.0,
			"building_damage": 26.0,
			"air": false,
			"fly_height": 0.0,
			"can_garrison": false,
			"projectile_speed": 42.0,
			"extent": Vector3(3.1, 2.4, 5.2),
			"blurb": "Rocket battery. Saturates an area.",
		},
		Kind.HELICOPTER: {
			"name": "Helicopter",
			"short": "Heli",
			...
			"splash": 2.0,
			"wall_damage": 8.0,
			"building_damage": 14.0,
			"air": true,
			"fly_height": 12.0,
			"can_garrison": false,
			"projectile_speed": 0.0,
			"extent": Vector3(3.2, 2.0, 4.8),
			"blurb": "Flies over river, walls, and hills.",
		},
	}
